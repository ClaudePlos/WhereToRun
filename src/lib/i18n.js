...
export const ui = {
  en: {
    ...
    'nav.poland': 'Poland',
    'country.title': 'Running events in {country}',
    'country.description': 'Every event in {country} the collector knows about — dates, distances, entry fees where published, and the start on the map.',
    'country.none': 'No upcoming events in {country} yet. The collector adds them as they are published.',
  ...
  pl: {
    ...
    'nav.poland': 'Polska',
    'country.title': 'Imprezy biegowe: {country}',
    'country.description': 'Wszystkie imprezy, jakie zna automat, dla kraju: {country}. Terminy, dystanse, opłaty startowe tam, gdzie są opublikowane, i miejsce startu na mapie.',
    'country.none': 'Brak nadchodzących imprez dla kraju: {country}. Automat dopisze je, gdy tylko się pojawią.',
